                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="partialPaymentModalLabel">Pay Partial Amount
                                                    </h5>
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '.btnShowInvoice', function(event) {
            ...
            var modalFooter = $('#modalInvoice').find('.modal-footer');
...
`);
        ...
        $(document).ready(function() {
            ...
            $('#partialPaymentModal').on('show.bs.modal', function(event) {
                ...
                modal.find('#partialAmount').attr('max',
                    remainingAmount); // Set max value for partial payment
            });
        });
    </script>
@endsection
