...
@section('content-header', __('Suppliers List. Select to see purchase orders'))
                    ...
                    @foreach ($suppliers as $supplier)
                       ...
                       <img width="50" src="{{$supplier->getAvatarUrl()}}" alt="">
                            ...
                            <td>
                                ...
                                <!-- <a href="{{ route('purchaseorders.create', $supplier) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a> -->
                                {{-- <button class="btn btn-primary btn-delete" data-url="{{route('suppliers.destroy', $supplier)}}"><i class="fas fa-plus"></i></button> --}}
                            </td>
                        </tr>
                    @endforeach
                </tbody>
